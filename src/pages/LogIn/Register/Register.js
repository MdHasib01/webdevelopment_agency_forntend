...
import { Alert, Button, Card, CardContent, CircularProgress, Container, Grid, TextField, Typography, FormControl, InputLabel, Select, MenuItem } from '@mui/material';
...
const Register = () => {
    ...
    const handleRegister = e => {
        ...
        registerUser(loginData.email, loginData.password, loginData.name, role, history);
                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={12} md={12} style={{ textAlign: 'center' }}>
                                ...
                                {!isLoading && <form onSubmit={handleRegister}>
                                    ...
                                    <br />
                                    <NavLink to="/login" style={{ textDecoration: 'none', marginLeft: '10px', marginBottom: '30px' }}>Already registerd?Please Login.</NavLink>
                                </form>}
                                {
