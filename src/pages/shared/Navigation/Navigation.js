                        ...
                        {isMobile ? (
                            ...
                            : (
                                <div>
                                    ...
                                    <NavLink style={{ textDecoration: 'none', color: 'white', marginRight: '10px' }} to="/complain">Complain</NavLink>
                                    <NavLink style={{ textDecoration: 'none', color: 'white', marginRight: '10px' }} to="/jobs">Job's</NavLink>


                                    <NavLink style={{ textDecoration: 'none', color: 'white', marginRight: '10px' }} to="/dashboard">Dashboard</NavLink>
                                    {/* {role?.role === 'buyer' &&  */}
                                    < NavLink style={{ textDecoration: 'none', color: 'white', marginRight: '10px' }} to="/developers">Developers</NavLink>
