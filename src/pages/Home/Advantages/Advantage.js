    ...
    return (
        <section className="advantage-section  mb-5">
            <div className="text-center">
                <p className="ad-text">1000+ website designes
                </p>
                <h2 className="fs-1 fw-bold">Web Development Agency <span>Advantages</span>
                </h2>
            </div>
                    ...
                    <div className="col">
                        <div className="card d-block text-center card-hover">
                            ...
                            <div className="card-body pb-5">
                                ...
                                <p className="fw-bold ad-text">Lots of Branch Locations</p>
